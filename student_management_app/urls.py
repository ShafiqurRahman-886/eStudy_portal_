...
from . import views
from .import HodViews, StaffViews, StudentViews, GeneralViews


urlpatterns = [
    path('', GeneralViews.homePage, name="home"),
    path('about/', GeneralViews.aboutPage, name="about"),
    path('contact/', GeneralViews.contactPage, name="contact"),
    path('doContact/', views.doContact, name="doContact"),
